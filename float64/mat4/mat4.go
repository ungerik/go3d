...
func (mat *T) IsZeroEps(epsilon float64) bool {
	return math.Abs(mat[0][0]) <= epsilon && math.Abs(mat[0][1]) <= epsilon && math.Abs(mat[0][2]) <= epsilon && math.Abs(mat[0][3]) <= epsilon &&
		math.Abs(mat[1][0]) <= epsilon && math.Abs(mat[1][1]) <= epsilon && math.Abs(mat[1][2]) <= epsilon && math.Abs(mat[1][3]) <= epsilon &&
		math.Abs(mat[2][0]) <= epsilon && math.Abs(mat[2][1]) <= epsilon && math.Abs(mat[2][2]) <= epsilon && math.Abs(mat[2][3]) <= epsilon &&
		math.Abs(mat[3][0]) <= epsilon && math.Abs(mat[3][1]) <= epsilon && math.Abs(mat[3][2]) <= epsilon && math.Abs(mat[3][3]) <= epsilon
}
